...
orderRouter.get('/:productId', (0, auth_1.default)(auth_interface_1.USER_ROLE.admin, auth_interface_1.USER_ROLE.user), orders_controller_1.orderController.getSingleOrder);
orderRouter.put('/:productId', (0, auth_1.default)(auth_interface_1.USER_ROLE.admin, auth_interface_1.USER_ROLE.user), orders_controller_1.orderController.updateOrder);
orderRouter.delete('/:productId', (0, auth_1.default)(auth_interface_1.USER_ROLE.admin, auth_interface_1.USER_ROLE.user), orders_controller_1.orderController.deleteOrder);
